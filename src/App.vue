  ...
  <div>
    <div class="container mx-auto flex flex-col items-center bg-gray-100 p-4">
      <div class="container">
        ...
        <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
          ...
          >
            <div class="px-4 py-5 sm:p-6 text-center">
              <dt class="text-sm font-medium text-gray-500 truncate">{{ t.name }}</dt>
        ...
        <hr v-if="tickers.length" class="w-full border-t border-gray-600 my-4" />
        <section v-if="closeGraph" class="relative">
          <h3 class="text-lg leading-6 font-medium text-gray-900 my-8">{{ selected?.name }}</h3>
...
export default {
  ...
  methods: {
    ...
    add() {
      ...
      subscribeToTicker(this.ticker, (newPrice) => this.updateTickers(this.ticker, newPrice));
      this.ticker = '';
      this.filtered = '';
    },
    async loadCoins() {
